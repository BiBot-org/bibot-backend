...
public interface IPaymentHistoryService {
    ...
    PaymentRes.PaymentHistoryInfo getPaymentHistoryByApprovalId(String approvalId);
    ...
    String updatePaymentFromApprovalUpdate(PaymentReq.ApprovalEndPaymentReq req);
}
